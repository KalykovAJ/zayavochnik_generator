...
SOURCE_FILE = r"C:\Users\Пользователь\Desktop\Справочники\Справочник МП.xlsm"
OUTPUT_FILE = r"C:\Users\Пользователь\Desktop\Заявочники АЗС\Заявочник МП Non-Food.xlsx"
...
# Здесь остались ТОЛЬКО значения, которые отличают сеть Мунай Пром Non-Food
...
EXCEL_STYLES = build_excel_styles({
    "colors": {
        ...
        "bg_pack": "E6F0FA"    # Фон для товаров, заказываемых УПАКОВКАМИ
    },
    "fonts": {
    ...
    "top_header": {
        ...
        "company_name": "Мунай Пром Non-Food"
    }
})
