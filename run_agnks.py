...
SOURCE_FILE = r"C:\Users\Пользователь\Desktop\Справочники\Справочник АГНКС.xlsm"
OUTPUT_FILE = r"C:\Users\Пользователь\Desktop\Заявочники АЗС\Заявочник АГНКС.xlsx"
...
EXCEL_STYLES = build_excel_styles({
    ...
    "fonts": {
        "header": {"name": "Calibri", "size": 11, "bold": True, "color": "E5E6E0"}
    },
    "top_header": {
        "bg_color": "0170D1",
        "text_color_yellow": "FAE116",
        "text_color_white": "FEFFFD",
        "company_name": "Газинтерсервис",
        "fuel_station": "АГНКС №"
    }
})

if __name__ == "__main__":
    print("--- Запуск генерации заявочника для сети АГНКС ---")
    build_zaevochnik(
