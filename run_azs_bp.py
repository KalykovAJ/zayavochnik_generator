...
EXCEL_STYLES = {
    ...
    "colors": {
        "primary": "FAE116",  # Основной корпоративный цвет (заливка шапки таблицы)
        "bg_pack": "DDF0E1",  # Светло-голубой фон для товаров, заказываемых УПАКОВКАМИ
    ...
    "top_header": {
        "bg_color": "10AA19",         # фон всей верхней шапки (строки 1-4)
        "font_name": "Cambria",        # Шрифт по ТЗ
        "text_color_yellow": "FAE116", # Цвет для дат и подписей
        "text_color_white": "FEFFFD",  # Цвет для названия компании
        "border": "D9D9D9",
